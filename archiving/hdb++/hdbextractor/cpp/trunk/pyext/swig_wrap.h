...
#ifndef SWIG_hdbextractor_WRAP_H_
#define SWIG_hdbextractor_WRAP_H_

#include <map>
#include <string>


class SwigDirector_HdbExtractorListener : public HdbExtractorListener, public Swig::Director {
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class HdbExtractorListener doesn't exist, undefined ";
          msg += method_name;
